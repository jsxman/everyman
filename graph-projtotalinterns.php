...
$strSQL1 = "SELECT";
$strSQL1.= " AP.date, sum(AP.hours) as thours, AP.project_id";
...
/* find the number of interns - add this to the headcount */
$strSQL2 = "SELECT *";
$strSQL2.= " FROM $TABLE_PERSON";
$strSQL2.= " WHERE employee_type='Intern'";
//echo "QUERY:<dir>$strSQL2</dir>";
...
for($i=0; $i<count($labels); $i++)
{
  $data0[9999999][$i]=$numInterns*160;//$numInterns;
}
//echo "NUM-I**".$numInterns."**<BR>\n";
//exit;
...
$x=$strAccum?" Accum":"";
$textBoxObj = $c->addTitle("Staff Level by Project", "timesbi.ttf", 12);
unset($x);
...
foreach($data0 as $key=>$value)
{
   ...
   $layer->addDataSet($value, -1, $projName);
