...
$x=$strAccum?" Accum":"";
$textBoxObj = $c->addTitle("System Eng Dept Staff Level (Future Split & Scaled) Absences", "timesbi.ttf", 12);
unset($x);
...
$dataX=Array();
for($i=0;$i<12;$i++){$dataX[$i]=$installs['se']['staff'];}
