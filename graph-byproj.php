...
$strAccum = 0;
$strProject =isset($_FORM['txtproject'])?postedData($_FORM['txtproject']):0;
...
$strSQL0 = "SELECT";
$strSQL0.= " AP.date, sum(AP.hours) as thours, P.name";
$strSQL0.= " FROM $TABLE_ACTIVEPERSON AS AP";
$strSQL0.= " LEFT JOIN $TABLE_PROJECT AS P ON P.id=AP.project_id";
$strSQL0.= " WHERE AP.date >= '$sYear-$sMonth-01' AND AP.date <= '$eYear-$eMonth-01' AND P.id='$strProject'";
...
$strSQL1 = "SELECT name FROM $TABLE_PROJECT WHERE id=$strProject";
...
//$strSQL1.= " WHERE AP.date >= '$Y-01-01' AND AP.date <= '$NY-12-01' AND P.supervisor_id='$strPerson'";
//$strSQL1.= " GROUP BY AP.date";
//$strSQL1.= " ORDER BY AP.date ASC";
$result1 = dbquery($strSQL0);
//debug(10,$strSQL1);
